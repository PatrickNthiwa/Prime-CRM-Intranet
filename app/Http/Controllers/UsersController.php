...
//             if($requestData['is_active'] == 1) {
//                 $subject = "Your prime crm account have been activated";
//             } else {
//                 $subject = "Your prime crm account have been deactivated";
//             }
...
//         if(getSetting("enable_email_notification") == 1 && $old_roles->count() > 0 && is_array($old_roles) && $old_roles[0]->id != $request->role_id) {
//             // send notify email
//             $this->mailer->sendUpdateRoleEmail("Your prime crm account have updated role", $user);
//         }
