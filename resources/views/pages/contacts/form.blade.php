        ...
        <div class="row">
              <div class="col-md-1">
                <div class="form-group {{ $errors->has('position_title') ? 'has-error' : ''}}">
                    <label for="position_title" class="control-label">{{ 'Salutation' }}</label>
            ...
            <div class="col-md-2">
                <div class="form-group {{ $errors->has('referral_source') ? 'has-error' : ''}}">
                    <label for="referral_source" class="control-label">{{ 'Branch Name' }}</label>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="form-group {{ $errors->has('address_state') ? 'has-error' : ''}}">
                    <label for="address_state" class="control-label">{{ 'County' }}</label>
            ...
            <div class="col-md-2">
                <div class="form-group {{ $errors->has('address_city') ? 'has-error' : ''}}">
                    <label for="address_city" class="control-label">{{ 'Area | Location' }}</label>
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="form-group {{ $errors->has('project_type') ? 'has-error' : ''}}">
                    <label for="project_type" class="control-label">{{ 'Product Type' }}</label>
                    <input class="form-control" name="project_type" type="text" id="project_type" required value="{{ isset($contact->project_type) ? $contact->project_type : ''}}" >
                    {!! $errors->first('project_type', '<p class="help-block">:message</p>') !!}
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group {{ $errors->has('project_description') ? 'has-error' : ''}}">
                    <label for="project_description" class="control-label">{{ 'Product Description' }}</label>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('description') ? 'has-error' : ''}}">
                    <label for="description" class="control-label">{{ 'Short Notes (Explain something about this contact)' }}</label>
                    <textarea class="form-control" name="description" type="text" id="description"rows="4" cols="50">{{ isset($contact->description) ? $contact->description : ''}}</textarea>
